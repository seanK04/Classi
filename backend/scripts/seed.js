...
const courses = [
  {
    ...
    professors: ['Andy van Dam', 'John Hughes'],
    prerequisites: [],
    credits: 4,
    difficulty: 3.5,
    workload: 4.0,
  ...
  },
  {
    ...
    department: 'Computer Science',
    professors: ['Philip Klein', 'Roberto Tamassia'],
  ...
  },
  {
    ...
    professors: ['Richard Schwartz', 'Kavita Ramanan'],
  ...
  },
  {
    ...
    department: 'Computer Science',
    professors: ['Tim Nelson', 'Shriram Krishnamurthi'],
  ...
  },
  {
    ...
    department: 'Computer Science',
    professors: ['Michael Littman', 'Ellie Pavlick'],
